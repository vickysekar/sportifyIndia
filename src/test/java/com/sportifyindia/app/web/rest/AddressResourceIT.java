...
class AddressResourceIT {
    ...
    void putExistingAddress() throws Exception {
        ...
        await()
            ...
            .untilAsserted(() -> {
                ...
                assertThat(testAddressSearch.getPincode()).isEqualTo(UPDATED_PINCODE);
    ...
    void partialUpdateAddressWithPatch() throws Exception {
        ...
        partialUpdatedAddress.addressLine1(UPDATED_ADDRESS_LINE_1).pincode(UPDATED_PINCODE).state(UPDATED_STATE);
